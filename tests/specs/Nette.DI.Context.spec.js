describe('Nette.DI.Context', function () {
    ...
    beforeAll(function () {
        Context = _context.lookup('Nette.DI.Context');
        ...
        _context.register(TestClass, '__Test.Nette.DI.Context.TestClass');
        ...
        testInstance = new Context({
            ...
            services: {
                testService: '__Test.Nette.DI.Context.TestClass(%param2.subparam1%)'
            },
            factories: {
                testFactory1: '__Test.Nette.DI.Context.TestClass("splat")',
                testFactory2: { callback: function(baz) { return new TestClass(baz); }, params: ['ooomph']}
            }
        });
    });

    it('should implement the Nette.DI.Container mixin', function () {
    ...
    describe('addFactory()', function () {
        it('should add the specified factory to the instance', function () {
            testInstance.addFactory('testFactory3', '__Test.Nette.DI.Context.TestClass(baz: "splurt")');
