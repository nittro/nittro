describe('Nittro.DI.Container', function () {
    ...
    beforeAll(function () {
        ...
        _context.register(TestService, '__Test.Nittro.DI.Container.TestService');
    ...
    describe('addServiceDefinition()', function () {
        ...
        it('should accept a string as a service definition', function () {
            testInstance.addServiceDefinition('testService2', '__Test.Nittro.DI.Container.TestService("splat")');
    ...
    describe('runServices()', function () {
        it('should create any services which have the "run" flag set to true and haven\'t been created yet', function () {
            testInstance.addServiceDefinition('testService1', { factory: '__Test.Nittro.DI.Container.TestService("splat")', run: true });
            testInstance.addServiceDefinition('testService2', '__Test.Nittro.DI.Container.TestService("blurp")!');
            testInstance.addServiceDefinition('testService3', { factory: '__Test.Nittro.DI.Container.TestService("non-splat")' });
            testInstance.addServiceDefinition('testService4', '__Test.Nittro.DI.Container.TestService("unblurp")');
